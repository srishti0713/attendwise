...
const OverallCard = ({ subjects }) => {
    ...
    // Already computed and attached by backend on every subject object
    const { totalAttended, totalClasses, overallPercentage } = subjects[0];
    console.log("Overall Attendance Data:", { totalAttended, totalClasses, overallPercentage });
    const status =
        ...
        <div className="p-4 pb-24">
            ...
            <div className="flex justify-between items-center mb-6 max-w-2xl mx-auto">
                ...
                <select
                    ...
                    className="bg-[#E8E0F8] text-[#4A20C4] border-none rounded-full px-4 py-2 text-sm font-semibold outline-none cursor-pointer"
                >
