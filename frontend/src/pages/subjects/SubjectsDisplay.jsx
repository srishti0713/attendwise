...
//             const { data: subjects = [], isLoading } = useSubjects(semester);
//         }
//     }, [selectedSemester]);
...
//     return (
//         <div className="min-h-screen bg-linear-to from-blue-100 to-blue-300 p-6">
//             {/* Header */}
...
const SubjectsDisplay = () => {
    ...
    // ✅ FIX: use selectedSemester, not semester
    const { data: subjects = [], isLoading } = useSubjects(selectedSemester);

    // ✅ declare AFTER usage fix
    const { data: semester } = useSemester(selectedSemester);
